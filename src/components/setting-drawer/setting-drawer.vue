<template>
    <div class="setting-drawer" ref="settingDrawer">
        ...
        >
            <div class="setting-drawer-index-content">
                ...
                <div :style="{ marginBottom: '24px' }">
                    ...
                    <div class="setting-drawer-index-blockChecbox">
                        <a-tooltip>
                            ...
                            <div @click="handleMenuTheme('dark')" class="setting-drawer-index-item">
                                <img alt="dark"
                        ...
                        <a-tooltip>
                            ...
                            <div @click="handleMenuTheme('light')" class="setting-drawer-index-item">
                                <img alt="light"
                ...
                <div :style="{ marginBottom: '24px' }">
                    ...
                    <div style="height: 20px">
                        <a-tooltip :key="index" class="setting-drawer-theme-color-colorBlock"
                ...
                <div :style="{ marginBottom: '24px' }">
                    ...
                    <div class="setting-drawer-index-blockChecbox">
                        <a-tooltip>
                            ...
                            <div @click="handleLayout('sidemenu')" class="setting-drawer-index-item">
                                <img alt="sidemenu"
                        ...
                        <a-tooltip>
                            ...
                            <div @click="handleLayout('topmenu')" class="setting-drawer-index-item">
                                <img alt="topmenu"
                        ...
                        <a-list :split="false">
                            <a-list-item>
                                <a-tooltip slot="actions">
                                    ...
                                    <a-select :defaultValue="contentWidth" @change="handleContentWidthChange"
                                              size="small"
                                              style="width: 80px;">
                                        <a-select-option value="Fixed">固定</a-select-option>
                                        <a-select-option v-if="layoutMode !== 'sidemenu'" value="Fluid">流式
                                        </a-select-option>
                                    </a-select>
                                </a-tooltip>
                                <a-list-item-meta>
                            ...
                            <a-list-item>
                                <a-switch :defaultChecked="fixedHeader" @change="handleFixedHeader" size="small"
                                          slot="actions"/>
                                <a-list-item-meta>
                            ...
                            <a-list-item>
                                <a-switch :defaultChecked="autoHideHeader" :disabled="!fixedHeader"
                                          @change="handleFixedHeaderHidden"
                                          size="small" slot="actions"/>
                                <a-list-item-meta>
                                    <a-tooltip placement="left" slot="title">
                            ...
                            <a-list-item>
                                <a-switch :defaultChecked="fixSiderbar" :disabled="(layoutMode === 'topmenu')"
                ...
                <div :style="{ marginBottom: '24px' }">
                    ...
                    <div>
                        <a-list :split="false">
                            <a-list-item>
                                <a-switch :defaultChecked="colorWeak" @change="onColorWeak" size="small"
                                          slot="actions"/>
                                <a-list-item-meta>
                            ...
                            <a-list-item>
                                <a-switch :defaultChecked="multiTab" @change="onMultiTab" size="small" slot="actions"/>
                                <a-list-item-meta>
                ...
                <div :style="{ marginBottom: '24px' }">
                    ...
                    <a-alert :style="{ marginTop: '24px' }" type="warning">
            <span slot="message">
            ...
            <div @click="toggle" class="setting-drawer-index-handle">
...
<script lang="ts">
    ...
    import {colorList, updateColorWeak, updateTheme} from "./setting-config";
    ...
    export default class SettingDrawer extends mixins(Mixin,MixinDevice) {
